...
_lr_productions = [
  ...
  ('SymbolicQuery -> AE expression','SymbolicQuery',2,'p_symbolic_query','parser.py',21),
  ('SymbolicQuery -> AG expression','SymbolicQuery',2,'p_symbolic_query','parser.py',22),
  ('SymbolicQuery -> EG expression','SymbolicQuery',2,'p_symbolic_query','parser.py',23),
  ('SymbolicQuery -> EE expression','SymbolicQuery',2,'p_symbolic_query','parser.py',24),
  ('SymbolicQuery -> expression ARROW expression','SymbolicQuery',3,'p_symbolic_query','parser.py',25),
  ('List -> expression','List',1,'p_List','parser.py',46),
  ('List -> expression COMMA List','List',3,'p_List','parser.py',47),
  ('expression -> bin_op_lv8','expression',1,'p_EXPRESSION','parser.py',57),
  ('bin_op_lv8 -> bin_op_lv7','bin_op_lv8',1,'p_binop_level_8','parser.py',74),
  ('bin_op_lv8 -> bin_op_lv7 IMPLIES bin_op_lv8','bin_op_lv8',3,'p_binop_level_8','parser.py',75),
  ('bin_op_lv7 -> bin_op_lv6','bin_op_lv7',1,'p_binop_level_7','parser.py',86),
  ('bin_op_lv7 -> bin_op_lv6 UNION bin_op_lv7','bin_op_lv7',3,'p_binop_level_7','parser.py',87),
  ('bin_op_lv6 -> bin_op_lv5','bin_op_lv6',1,'p_binop_level_6','parser.py',99),
  ('bin_op_lv6 -> bin_op_lv5 XOR bin_op_lv6','bin_op_lv6',3,'p_binop_level_6','parser.py',100),
  ('bin_op_lv6 -> bin_op_lv5 AND bin_op_lv6','bin_op_lv6',3,'p_binop_level_6','parser.py',101),
  ('bin_op_lv6 -> bin_op_lv5 OR bin_op_lv6','bin_op_lv6',3,'p_binop_level_6','parser.py',102),
  ('bin_op_lv5 -> bin_op_lv4','bin_op_lv5',1,'p_binop_level_5','parser.py',114),
  ('bin_op_lv5 -> bin_op_lv4 GT bin_op_lv5','bin_op_lv5',3,'p_binop_level_5','parser.py',115),
  ('bin_op_lv5 -> bin_op_lv4 LE bin_op_lv5','bin_op_lv5',3,'p_binop_level_5','parser.py',116),
  ('bin_op_lv5 -> bin_op_lv4 GE bin_op_lv5','bin_op_lv5',3,'p_binop_level_5','parser.py',117),
  ('bin_op_lv5 -> bin_op_lv4 EQ bin_op_lv5','bin_op_lv5',3,'p_binop_level_5','parser.py',118),
  ('bin_op_lv5 -> bin_op_lv4 NE bin_op_lv5','bin_op_lv5',3,'p_binop_level_5','parser.py',119),
  ('bin_op_lv5 -> bin_op_lv4 LT bin_op_lv5','bin_op_lv5',3,'p_binop_level_5','parser.py',120),
  ('bin_op_lv4 -> bin_op_lv3 PLUS bin_op_lv4','bin_op_lv4',3,'p_binop_level_4','parser.py',133),
  ('bin_op_lv4 -> bin_op_lv3 MINUS bin_op_lv4','bin_op_lv4',3,'p_binop_level_4','parser.py',134),
  ('bin_op_lv4 -> bin_op_lv3 LSHIFT bin_op_lv4','bin_op_lv4',3,'p_binop_level_4','parser.py',135),
  ('bin_op_lv4 -> bin_op_lv3 RSHIFT bin_op_lv4','bin_op_lv4',3,'p_binop_level_4','parser.py',136),
  ('bin_op_lv4 -> bin_op_lv3','bin_op_lv4',1,'p_binop_level_4','parser.py',137),
  ('bin_op_lv3 -> sub_expression TIMES bin_op_lv3','bin_op_lv3',3,'p_binop_level_3','parser.py',151),
  ('bin_op_lv3 -> sub_expression DIVIDE bin_op_lv3','bin_op_lv3',3,'p_binop_level_3','parser.py',152),
  ('bin_op_lv3 -> sub_expression MOD bin_op_lv3','bin_op_lv3',3,'p_binop_level_3','parser.py',153),
  ('bin_op_lv3 -> sub_expression','bin_op_lv3',1,'p_binop_level_3','parser.py',154),
  ('sub_expression -> LPAREN expression RPAREN','sub_expression',3,'p_SUB_expression','parser.py',166),
  ('sub_expression -> NOT expression','sub_expression',2,'p_SUB_expression','parser.py',167),
  ('sub_expression -> primary','sub_expression',1,'p_SUB_expression','parser.py',168),
  ('primary -> IDENTIFIER','primary',1,'p_simple_expression','parser.py',182),
  ('primary -> POS_INTEGER','primary',1,'p_simple_expression','parser.py',183),
]
